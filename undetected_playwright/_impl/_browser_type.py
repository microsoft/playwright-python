...
from undetected_playwright._impl._browser import Browser, prepare_browser_context_params
...
from undetected_playwright._impl._json_pipe import JsonPipeTransport
from undetected_playwright._impl._network import serialize_headers
from undetected_playwright._impl._waiter import throw_on_timeout
...
class BrowserType(ChannelOwner):
    ...
    async def connect(
        ...
        headers = {**(headers if headers else {}), "x-undetected_playwright-browser": self.name}
