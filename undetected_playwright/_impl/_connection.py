...
from undetected_playwright._impl._helper import Error, ParsedMessagePayload, parse_error
...
def _extract_stack_trace_information_from_stack(
    ...
    playwright_module_path = str(Path(undetected_playwright.__file__).parents[0])
