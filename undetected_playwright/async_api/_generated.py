...
from undetected_playwright._impl._api_structures import (
    Cookie,
    FilePayload,
    FloatRect,
    Geolocation,
...
from undetected_playwright._impl._assertions import LocatorAssertions as LocatorAssertionsImpl
from undetected_playwright._impl._assertions import PageAssertions as PageAssertionsImpl
from undetected_playwright._impl._async_base import (
    AsyncBase,
    AsyncContextManager,
...
from undetected_playwright._impl._fetch import APIRequest as APIRequestImpl
from undetected_playwright._impl._fetch import APIRequestContext as APIRequestContextImpl
from undetected_playwright._impl._fetch import APIResponse as APIResponseImpl
...
from undetected_playwright._impl._input import Keyboard as KeyboardImpl
from undetected_playwright._impl._input import Mouse as MouseImpl
from undetected_playwright._impl._input import Touchscreen as TouchscreenImpl
from undetected_playwright._impl._js_handle import JSHandle as JSHandleImpl
from undetected_playwright._impl._locator import FrameLocator as FrameLocatorImpl
from undetected_playwright._impl._locator import Locator as LocatorImpl
from undetected_playwright._impl._network import Request as RequestImpl
from undetected_playwright._impl._network import Response as ResponseImpl
from undetected_playwright._impl._network import Route as RouteImpl
from undetected_playwright._impl._network import WebSocket as WebSocketImpl
from undetected_playwright._impl._page import Page as PageImpl
from undetected_playwright._impl._page import Worker as WorkerImpl
...
class Frame(AsyncBase):
    ...
    async def wait_for_selector(
        ...
        **Usage**
        ...
        async def run(undetected_playwright: Playwright):
            chromium = undetected_playwright.chromium
        ...
        async def main():
            async with async_playwright() as undetected_playwright:
                await run(undetected_playwright)
        asyncio.run(main())
        ```
        ...
        def run(undetected_playwright: Playwright):
            chromium = undetected_playwright.chromium
        ...
        with sync_playwright() as undetected_playwright:
            run(undetected_playwright)
        ```
    ...
    def get_by_placeholder(
        ...
        **Usage**
        ...
        ```py
        await page.get_by_placeholder(\"name@example.com\").fill(\"undetected_playwright@microsoft.com\")
        ```

        ```py
        page.get_by_placeholder(\"name@example.com\").fill(\"undetected_playwright@microsoft.com\")
        ```
    ...
    async def wait_for_function(
        ...
        **Usage**
        ...
        async def run(undetected_playwright: Playwright):
            webkit = undetected_playwright.webkit
    ...
    async def register(
        ...
        **Usage**
        ...
        async def run(undetected_playwright: Playwright):
            ...
            await undetected_playwright.selectors.register(\"tag\", tag_selector)
            browser = await undetected_playwright.chromium.launch()
            page = await browser.new_page()
        ...
        def run(undetected_playwright: Playwright):
            ...
            # Register the engine. Selectors will be prefixed with \"tag=\".
            undetected_playwright.selectors.register(\"tag\", tag_selector)
            browser = undetected_playwright.chromium.launch()
            page = browser.new_page()
...
class Page(AsyncContextManager):
    ...
    async def add_init_script(
        ...
        **Usage**
        ...
        ```py
        # in your undetected_playwright script, assuming the preload.js file is in same directory
    ...
    async def pause(self) -> None:
        ...
        button in the page overlay or to call `undetected_playwright.resume()` in the DevTools console.
...
class Browser(AsyncContextManager):
    ...
    async def new_context(
        ...
        **Usage**
        ...
        ```py
        browser = await undetected_playwright.firefox.launch() # or \"chromium\" or \"webkit\".
        ...
        ```py
        browser = undetected_playwright.firefox.launch() # or \"chromium\" or \"webkit\".
        # create a new incognito browser context.
        context = browser.new_context()
        # create a new page in a pristine context.
        page = context.new_page()
...
class BrowserType(AsyncBase):
    ...
    async def launch(
        ...
        **Usage**
        ...
        ```py
        browser = await undetected_playwright.chromium.launch( # or \"firefox\" or \"webkit\".
            ignore_default_args=[\"--mute-audio\"]
        )
        ```

        ```py
        browser = undetected_playwright.chromium.launch( # or \"firefox\" or \"webkit\".
            ignore_default_args=[\"--mute-audio\"]
        )
        ```
    ...
    async def connect_over_cdp(
        ...
        **Usage**
        ...
        ```py
        browser = await undetected_playwright.chromium.connect_over_cdp(\"http://localhost:9222\")
        default_context = browser.contexts[0]
        page = default_context.pages[0]
        ```

        ```py
        browser = undetected_playwright.chromium.connect_over_cdp(\"http://localhost:9222\")
        default_context = browser.contexts[0]
        page = default_context.pages[0]
        ```
...
class Playwright(AsyncBase):
    ...
    def devices(self) -> typing.Dict:
        ...
        async def run(undetected_playwright: Playwright):
            webkit = undetected_playwright.webkit
            iphone = undetected_playwright.devices[\"iPhone 6\"]
            browser = await webkit.launch()
    ...
    async def stop(self) -> None:
        ...
        undetected_playwright = sync_playwright().start()
...
class PageAssertions(AsyncBase):
    async def to_have_title(
        ...
        **Usage**
        ...
        ```py
        import re
        from undetected_playwright.async_api import expect
        ...
        ```py
        import re
        from undetected_playwright.sync_api import expect
