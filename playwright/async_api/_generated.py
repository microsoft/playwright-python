...
class LocatorAssertions(AsyncBase):
    ...
    async def has_count(self, count: int, *, timeout: float = None) -> NoneType:
    ...
    async def is_checked(self, *, timeout: float = None) -> NoneType:
    ...
    async def is_disabled(self, *, timeout: float = None) -> NoneType:
    ...
    async def is_editable(self, *, timeout: float = None) -> NoneType:
    ...
    async def is_empty(self, *, timeout: float = None) -> NoneType:
    ...
    async def is_enabled(self, *, timeout: float = None) -> NoneType:
    ...
    async def is_hidden(self, *, timeout: float = None) -> NoneType:
    ...
    async def is_visible(self, *, timeout: float = None) -> NoneType:
    ...
    async def is_focused(self, *, timeout: float = None) -> NoneType:
