...
class Accessibility(AsyncBase):
    ...
    async def snapshot_for_ai(self) -> typing.Optional[typing.Dict]:
        """Accessibility.snapshot_for_ai
        
        Captures the complete accessibility tree **without pruning** and returns data formatted specifically for
        Playwright's AI-powered tooling. Unlike `snapshot`, this method:
        - Always includes all nodes (equivalent to `interestingOnly: false`).
        - May expose additional internal metadata used by AI features.
        - Is **not** deprecated.
