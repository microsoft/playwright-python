...
class BrowserType(ChannelOwner):
    ...
    async def launch(
        ...
        browser.connect_to_browser_type(self, str(tracesDir))
        return browser
    ...
    async def launch_persistent_context(
        ...
        params = locals_to_params(locals())
        await self.prepare_browser_context_params(params)
        normalize_launch_params(params)
    ...
    async def connect_over_cdp(
        ...
        browser.connect_to_browser_type(self, None)
    ...
    async def prepare_browser_context_params(self, params: Dict) -> None:
