...
from playwright._api_types import DeviceDescriptor, Geolocation, FilePayload, FloatPoint, FloatRect, HttpCredentials, IntSize, PdfMargins, ProxySettings, OptionSelector, SourceLocation, RequestFailure, RecordHarOptions, RecordVideoOptions
